...
export const inspectionChecklist = [
  {
    section: "packingArea",            // <c-question-list fields="packingArea">
    items: [
      {
  ...
  {
    section: "containerCondition",     // <c-question-list fields="containerCondition">
    items: [
      {
  ...
  {
    section: "packingContainer",       // <c-question-list fields="packingContainer">
    items: [
      {
  ...
  {
    section: "dangerousGoods",         // <c-question-list fields="dangerousGoods">
    items: [
      {
  ...
  {
    section: "afterPacking",           // <c-question-list fields="afterPacking">
    items: [
      {
  ...
  {
    section: "closingContainer",       // <c-question-list fields="closingContainer">
    items: [
      {
  ...
  {
    section: "dispatchingContainer",   // <c-question-list fields="dispatchingContainer">
    items: [
      {
